...
/>
            ...
            <div className="flex items-center space-x-4">
              <div className="relative">
                ...
                <Input
                  ...
                  className="w-64 pr-12 gc-input border-gray-400 focus:border-[#3b99fc]"
                />
                <Button
                  size="sm"
                  className="absolute right-0 top-0 h-full px-3 bg-[#26374a] hover:bg-[#1c2b3a] border-0"
                  aria-label="Search"
                >
                  <Search className="h-4 w-4" />
                </Button>
              </div>
              <button className="text-sm text-[#26374a] hover:text-[#af3c43] font-semibold underline">Français</button>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="bg-[#26374a]">
        <div className="container mx-auto px-4">
          <button
            className="flex items-center space-x-2 text-white py-3 px-4 hover:bg-[#1c2b3a] transition-colors"
